                                ...
                                <table class="table table-bordered table-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-quantity col-sm-2">Quantity</th>
                                    ...
                                    <tbody>
                                        @foreach ( $cartItem as $item )
                                            <tr>
                                                ...
                                                <td class="product-name text-nowrap">
                                                    <h2 class="h5 text-black">{{ $item->nama }}</h2>
                                                </td>
                                                <td>
                                                    Rp{{ $item->harga }}
                                                </td>
                                                <form action="/cart/{{ $item->id }}/update-item">
                                                    @csrf
                                                    <td class="">
                                                    ...
                                                    <td id="total">Rp{{ $item->harga * $item->quantity }}</td>
                                                    <td><a href="/cart/{{ $item->id }}/update-item/{{ $item->quantity }}" name="quantity" class="update btn btn-primary btn-sm btn-block">Update Cart</a></td>
                                                </form>
                                                <td><a href="/cart/{{ $item->id }}/hapus-item" class="delete btn btn-primary btn-sm" data-id="{{ $item->id }}">X</a></td>
                                            </tr>
                                            <?php
        ...
        $('.delete').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = '/cart/'+itemId+'/hapus-item'
                    Swal.fire(
                    'Deleted!',
