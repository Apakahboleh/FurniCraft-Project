    ...
    @include('partials.navbarAuth')
        <div class="container mt-5">
            <div class="row">
                <div class="col">
                    <center>
                        <h1>Buat Living Room</h1>
                        <p>Tambahkan Living Room Kedalam Kategori FurniCraft</p>
                    </center>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-sm-9 offset-sm-2">
                    <form action="/categories/livingRoom/add-furniture/store" enctype="multipart/form-data" method="post">
                        @csrf
