                    ...
                    <div class="col-lg-4" data-aos="fade-down" data-aos-delay="200">
                        <div class="item mb-4">
                            <div class="block-4 text-center">
                                <a class="block-2-item" href="/categories/office_furnitures/{{ Crypt::encrypt($office_furnitures->id) }}/detail">
                                ...
                                @can('admin')
                                    <a href="/categories/office_furnitures/{{ Crypt::encrypt($office_furnitures->id) }}/edit" class="btn btn-dark card-link mx-4"><span class="icon icon-edit"></span> Edit </a>
                                    <a href="/categories/office_furnitures/{{ Crypt::encrypt($office_furnitures->id) }}/delete" class="delete btn btn-danger card-link" data-id="{{ $office_furnitures->id }}"><span class="icon icon-trash"></span> Hapus </a>
                                @endcan
                                <div class="block-4-text p-4 text-left">
                                    <h3><a href="/categories/office_furnitures/{{ Crypt::encrypt($office_furnitures->id) }}/detail">{{ $office_furnitures->nama }}</a></h3>
                                    <p class="mb-0">
                                        <?php
