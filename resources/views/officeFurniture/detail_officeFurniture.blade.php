            ...
            <div class="container pb-5">
                <div class="row">
                    <div class="col-lg-5 mt-5">
                        <div class="card mb-3">
                            <img class="card-img img-fluid" src="/image/items/{{ $detail_office->image }}"  alt="Card image cap" id="product-detail">
                        </div>
                        <div class="row">
                            ...
                            <div id="multi-item-example" class="col-12 slide carousel-multi-item carousel-related-product" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    @if ($detail_office->image && $detail_office->image2 && $detail_office->image3)
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/{{ $detail_office->image }}" alt="Product Image 1">
                                                    </a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/{{ $detail_office->image2 }}" alt="Product Image 2">
                                                    </a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/{{ $detail_office->image3 }}" alt="Product Image 3">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    @elseif ($detail_office->image && !$detail_office->image2 && !$detail_office->image3)
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-4">
                                                    <a href="#">
                                                ...
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/unknown_offices.png" alt="Product Image 2">
                                                    </a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/unknown_offices.png" alt="Product Image 3">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @else
                                        <div class="carousel-item active">
                                            <div class="row">
                                                <div class="col-4">
                                                    <a href="#">
                                                        <img class="card-img img-fluid" src="/image/items/unknown_offices.png" alt="Product Image 1">
                                                    </a>
                                                </div>
                                                <div class="col-4">
                                                    <a href="#">
                    ...
                    <div class="col-lg-7 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="h2">{{ $detail_office->nama }}</h1>
                                <form action="/detail/office_furniture/update/{{ $detail_office->id }}" method="post">
                                    @csrf
                                    @method('put')
                                    <p class="h3 py-2">Harga : Rp{{ number_format($detail_office->harga, '2' ,'.', '.') }}0</p>
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <h6>Brand: FurniCraft</h6>
                                        </li>
                                        <li class="list-inline-item">
                                            <p class="text-muted"><strong>{{ $detail_office->brand }}</strong></p>
                                        </li>
                                    </ul>

                                    <h5>Deskripsi Produk:</h5>
                                    <div style="white-space:pre-line" class="mb-3">
                                        {{ $detail_office->deskripsi }}
                                    </div>
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        @if ($detail_office->panjang == NULL || $detail_office->lebar == NULL || $detail_office->tinggi == NULL)
                                            <h6 class="text-danger">{{ "Harap Mengisi Panjang, Lebar, Tinggi Agar Dapat Memesan" }}</h6>
                                        @else
                                        <form action="/detail/pesan/{{ $detail_office->id }}" method="post">
                                            @csrf
                                            <input type="hidden" name="nama" value="{{ $detail_office->nama }}">
                                            <input type="hidden" name="harga" value="{{ $detail_office->harga }}">
                                            <input type="hidden" name="quantity" value="1">
                                            <input type="hidden" name="image" value="{{ $detail_office->image }}">
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div id="carousel-related-product">
                ...
                @foreach ( $office_furnitures as $office_furniture )
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="card-body">
                            <h3 class="h3 text-decoration-none">{{ $office_furniture->nama }}</h3>
                            ...
                            <p style="font-weight: bold;" class="text-center mb-0">Rp{{ number_format($office_furniture->harga, '2' ,'.', '.') }}0</p>
                        </div>
                    </div>
                </div>
                @endforeach
