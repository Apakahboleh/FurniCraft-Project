...
@section('content')
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <center>
                    <h1>Buat Kitchen Set</h1>
                    <p>Tambahkan Kitchen Set Kedalam Kategori FurniCraft</p>
                </center>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-sm-9 offset-sm-2">
                <form action="/categories/kitchenSet/add-furniture/store" enctype="multipart/form-data" method="post">
                    @csrf
